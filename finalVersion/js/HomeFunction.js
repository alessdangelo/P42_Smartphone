...
function AddPhoneShowSlot(name, imagesource, background, infoArray, price, url, url2){
    phoneShowSlots.push(new PhoneShow(name,imagesource,background,infoArray,price,url, url2));
}
...
function GetNewWallpaper(){
    let sceen=document.getElementById("PhoneShow");
    sceen.style.backgroundImage="url(../oder/Image/PhoneShowBackground/PhoneShowBackground"+Math.floor(Math.random() * 9 + 1)+".jpg)";
}
