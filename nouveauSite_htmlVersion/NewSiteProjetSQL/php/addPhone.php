...
*/
    function AddPhoneToShowSlot($smartphoneName, $db){
        ...
        $name = $row["smaName"];
        $imagesource = '../oder/Image/PhonesImages/'.$row["idSmartphone"].".png";
        $background = '"../oder/Image/PhoneShowBackground/PhoneShowBackground"+(phoneShowSlots.length+1)+".jpg"';
